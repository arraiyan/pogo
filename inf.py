...
class env:
    ...
    price = f'r /price er value:1.29$ \nThe POGO token is ready for purchase now at: pogoswap.io/ido/0 🥳🥳 ONLY ON DESKTOP COMPUTER 🤓 Connect to MetaMask on the Binance Smart Chain to buy your POGO token which is currently'
